...
public class PickAnElement {
    ...
    public static void main(String[] args) {
        ...
        // Find a max element by a comparator
        Optional<String> longestName = friends.stream().reduce(BinaryOperator.maxBy(Comparator.comparing(String::length)));
        longestName.ifPresent(name -> System.out.println(String.format("A longest name: %s", name)));
    }
}
